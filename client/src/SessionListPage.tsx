    ...
    return (
      <main class="flex-grow flex flex-col bg-neutral-50 dark:bg-neutral-900 text-neutral-800 dark:text-neutral-200 min-h-screen">
        <div class="flex items-center justify-start gap-4 p-4 border-b border-neutral-200 dark:border-neutral-700">
          <h1 class="text-lg font-semibold">All Sessions</h1>
        </div>
        <div class="p-6 flex-grow">
            <Show when={!sessions.loading} fallback={<p class="text-neutral-500 dark:text-neutral-400">Loading sessions...</p>}>
                <Show when={sessions() && sessions()!.length > 0} fallback={<p class="text-neutral-500 dark:text-neutral-400">No sessions found.</p>}>
                    <div class="overflow-x-auto bg-white dark:bg-neutral-800 shadow-lg rounded-lg">
                        <table class="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
                            <thead class="bg-neutral-50 dark:bg-neutral-750"> {/* Added subtle bg to thead for better separation */}
